      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="form-control">
            ...
            <input className="input input-bordered" value={selectedSummary.type || ""} disabled />
          </label>
          ...
          <label className="form-control">
            ...
            <input
              ...
              value={selectedSummary.assignedDoctor ? selectedSummary.assignedDoctor.toString() : ""}
              disabled
            />
          </label>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-sm text-gray-500">{existingImages.length} image(s)</p>
          </div>
            ...
            {existingImages.map((img, idx) => {
              ...
              return (
                <div key={img.cid || img.url || idx} className="relative border rounded overflow-hidden">
                  ...
                  />
                  <div className="p-2 flex items-center justify-between bg-white/80">
                    <label className="flex items-center gap-2">
                      <input type="checkbox" checked={checked} onChange={() => toggleDeleteUrl(img.url)} className="checkbox" />
                      <span className="text-xs truncate max-w-[8rem]">{img.url.split("/").pop()}</span>
                    </label>
        ...
        <div>
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-medium">Upload New Images</h2>
            <span className="text-sm text-gray-500">{localFiles.length} selected</span>
          </div>
