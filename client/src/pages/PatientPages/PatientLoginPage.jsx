    ...
    <div className="min-h-screen flex items-center justify-center bg-base-200 px-4">
      <div className="w-full max-w-md">
          ...
          <div className="card-body p-6 sm:p-12">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Sign in to access dashboard</p>
              </div>
            </div>
        ...
        <div className="text-center mt-6 text-xs text-muted-foreground">
          <p>By signing in you agree to our <Link to="/terms" className="link hover:text-primary">Terms of Service</Link>.</p>
        </div>
      </div>
    </div>
  );
